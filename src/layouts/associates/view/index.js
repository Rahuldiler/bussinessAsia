...
import { investorsListTeam } from "Api/Api";
                  ...
                  Cell: (data) => {
                    return (
                      <SoftButton
                        ...
                        onClick={() => {
                          setLoader(true);
                          navigate(`/associates/view/${data.value}`)}}
                ...
                <SoftBox display="flex" justifyContent="space-between" alignItems="flex-start" p={3}>
                  <SoftBox lineHeight={1}>
                    <SoftTypography variant="h5" fontWeight="medium">
                      Associate list for Email: <span style={{color:"green"}}>{Email}</span>, Team BV: <span style={{color:"green"}}>{nodeAmount}</span>
                    </SoftTypography>
                  </SoftBox>
